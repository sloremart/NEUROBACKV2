    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('Tipo', models.CharField(choices=[], max_length=50)),
                ('NombreArchivo', models.CharField(default='sin_nombre', max_length=255)),
                ('RutaArchivo', models.FileField(blank=True, max_length=255, null=True, upload_to='gdocumental/archivosFacturacion')),
                ('NumeroAdmision', models.IntegerField()),
                ('Observacion', models.TextField(blank=True, null=True)),
                ('FechaCreacionArchivo', models.DateTimeField(auto_now_add=True)),
                ('FechaCreacionAntares', models.DateTimeField(blank=True, null=True)),
                ...
                ('Modificado1', models.BooleanField(blank=True, null=True)),
                ('Modificado2', models.BooleanField(blank=True, null=True)),
                ('Modificado3', models.BooleanField(blank=True, null=True)),
                ('IdRevisor', models.IntegerField(blank=True, null=True)),
                ('IdRevisorTesoreria', models.IntegerField(blank=True, null=True)),
                ('FechaRevisionPrimera', models.DateField(blank=True, null=True)),
            ],
            options={
                'db_table': 'archivos',
                'managed': True,
